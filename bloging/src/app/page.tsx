    ...
    <main className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-emerald-200 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <h1 className={`text-4xl font-bold mb-4 ${styles.text_turquoise}`}>Welcome</h1>
            ...
            <a href="/blog/posts" className={`outline outline-1 outline-offset-2 border-emerald-400 text-emerald-400 hover:text-white py-2 px-4 rounded hover:bg-emerald-500 md:w-auto ${styles.fit_content}`}>
              Go to Blog
            </a>
          </div>
      ...
      <div className={`hidden md:block absolute top-0 right-0 bottom-0 left-2/3 z-0 ${styles.bg_aquamarine}`}></div>
    </main>
  );
}